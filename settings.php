...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect(
        'enrol_autoenrol/newenrols',
        get_string('newenrols', 'enrol_autoenrol'),
        get_string('newenrols_desc', 'enrol_autoenrol'),
        1,
        $options
    ));
    ...
    $options = [1  => get_string('yes'), 0 => get_string('no')];
    $settings->add(new admin_setting_configselect(
        'enrol_autoenrol/loginenrol',
        get_string('loginenrol', 'enrol_autoenrol'),
        get_string('loginenrol_desc', 'enrol_autoenrol'),
        1,
        $options
    ));
    ...
    $options = [1  => get_string('yes'), 0 => get_string('no')];
    $settings->add(new admin_setting_configselect(
        'enrol_autoenrol/selfunenrol',
        get_string('selfunenrol', 'enrol_autoenrol'),
        get_string('selfunenrol_desc', 'enrol_autoenrol'),
        1,
        $options
    ));
    ...
    $options = [1  => get_string('yes'), 0 => get_string('no')];
    $settings->add(new admin_setting_configselect(
        'enrol_autoenrol/allowunsuspend',
        get_string('allowunsuspend', 'enrol_autoenrol'),
        get_string('allowunsuspend_desc', 'enrol_autoenrol'),
        0,
        $options
    ));
    ...
    $settings->add(new admin_setting_configduration(
        'enrol_autoenrol/enrolperiod',
        get_string('enrolperiod', 'enrol_autoenrol'),
        get_string('enrolperiod_desc', 'enrol_autoenrol'),
        0
    ));
    ...
    $settings->add(new admin_setting_configduration(
        'enrol_autoenrol/expirythreshold',
    ...
    $settings->add(new admin_setting_configselect(
        'enrol_autoenrol/longtimenosee',
        get_string('longtimenosee', 'enrol_autoenrol'),
        get_string('longtimenosee_help', 'enrol_autoenrol'),
        0,
        $options
    ));

    $settings->add(new admin_setting_configtext(
        'enrol_autoenrol/maxenrolled',
        get_string('maxenrolled', 'enrol_autoenrol'),
        get_string('maxenrolled_help', 'enrol_autoenrol'),
        0,
        PARAM_INT
    ));
    ...
    if (function_exists('enrol_send_welcome_email_options')) {
        ...
        $settings->add(new admin_setting_configselect(
            'enrol_autoenrol/sendcoursewelcomemessage',
    ...
    if (!during_initial_install()) {
        ...
        $settings->add(new admin_setting_configmultiselect(
            'enrol_autoenrol/availabilityplugins',
